...
namespace NeuralNetwork_UI.Forms
{
    public partial class OutputLayerForm : Form
    {
        ...
        {
            LayersHandler.RefreshLayerValues(DGVLayer, Neural_Network.Core.Implementation.Layers.Output, DecimalPlaces, true);
        ...
        {
            LayersHandler.RefreshLayerValues(DGVLayer, Neural_Network.Core.Implementation.Layers.Output, DecimalPlaces, rewriteValues);
        }
