...
namespace NeuralNetwork_UI.Forms
{
    public partial class InputLayerForm : Form
    {
        ...
        {
            LayersHandler.RefreshLayerValues(DGVLayer, Neural_Network.Core.Implementation.Layers.Input, DecimalPlaces, true);
        ...
        {
            LayersHandler.RefreshLayerValues(DGVLayer, Neural_Network.Core.Implementation.Layers.Input, DecimalPlaces, rewriteValues);
        }
