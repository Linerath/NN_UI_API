...
{
    public partial class InputLayerForm : Form
    {
        ...
        public InputLayerForm(int networkIndex)
        {
            InitializeComponent();
        ...
        {
            LayersHandler.RefreshLayerValues(NetworkIndex, DGVLayer, Neural_Network.Core.Implementation.Layers.Input, DecimalPlaces, true);
        ...
        {
            LayersHandler.RefreshLayerValues(NetworkIndex, DGVLayer, Neural_Network.Core.Implementation.Layers.Input, DecimalPlaces, rewriteValues);
        }
